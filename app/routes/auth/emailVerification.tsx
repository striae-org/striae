...
export const EmailVerification = ({ user, onSignOut, error, success, onError, onSuccess }: EmailVerificationProps) => {
		...
		<div className={styles.container}>
			...
			<div className={styles.formWrapper}>
				...
				<div className={styles.verificationActions}>
					...
					<button onClick={onSignOut} className={styles.loginToStriaeButton}>
						Login to Striae
					</button>
				</div>
