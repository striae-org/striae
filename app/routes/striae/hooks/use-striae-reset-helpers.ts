...
export const useStriaeResetHelpers = ({
	...
	}, [onRevokeImage, setSelectedImage, setSelectedFilename, setImageId, setAnnotationData, setError, setImageLoaded]);
	...
	}, [setActiveAnnotations, setIsBoxAnnotationMode, setIsReadOnlyCase, setIsReviewOnlyCase, setArchiveDetails]);
