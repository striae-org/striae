      ...
      <div id="top" className={`route-legal-container ${styles.container}`}>
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>The Service is for individuals 18+ and we do not knowingly collect data from children.</li>
...
<li>
<p><strong>For the performance of a contract:</strong> to provide, secure, and support the Service and to perform any agreement You enter into with Us in connection with the Service.</p>
</li>
<li>
<p><strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.</p>
</li>
<li>
<p><strong>To provide You</strong> with updates and general information about the Service and related offerings unless You have opted not to receive such information.</p>
</li>
<li>
...
<p>The Service is only available to individuals 18 years and older. We do not knowingly collect data from minors.</p>
        </section>
        <section className={styles.section}>
...
<ul>
<li><strong>Directly from You</strong>. For example, from the forms You complete on Our Service, preferences You express or provide through Our Service, or from verification details You provide (such as phone number, email address, and mailing/billing address).</li>
...
<li><strong>From Service Providers</strong>. For example, third-party vendors to monitor and analyze the use of Our Service, third-party vendors supporting payment-security verification and fraud prevention, or other third-party vendors that We use to provide the Service to You.</li>
</ul>
...
<li>To fulfill or meet the reason You provided the information. For example, if You share Your contact information to ask a question about Our Service, We will use that personal information to respond to Your inquiry. If You provide phone number, email address, or mailing/billing address for security verification, We will use that information to help authenticate accounts and prevent fraud or abuse.</li>
...
<li>Only minimal Identifiers (such as name, email, phone number, and mailing/billing address), employment verification details, and Internet Activity (usage logs for support/security) may be collected.</li>
<li>We do not collect or store full payment card numbers in Striae; limited payment-related contact details may be processed for security verification purposes.</li>
...
<li>Payment-security and fraud-prevention providers</li>
