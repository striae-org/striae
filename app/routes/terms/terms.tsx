    ...
    <>
      ...
      <div className={styles.content}>
        ...
        <hr />
          ...
          <ul>
            <li>Protect all uploaded images, case files, and reports as confidential casework materials; never share sensitive data outside authorized channels.</li>
            <li>Comply with all legal, regulatory, and institutional policies for data privacy and chain-of-custody when using Striae.</li>
          </ul>
          <h3>Maintain Data Security</h3>
          <ul>
            <li>Log in only through secure, authorized methods and never share your access credentials.</li>
            <li>Promptly report any suspected security concerns or breaches using the in-app support features.</li>
          </ul>
          <h3>Accuracy in Annotation and Reporting</h3>
          <ul>
            <li>Use the image annotation and comparison features carefully; double-check your work before saving data and finalizing reports.</li>
            <li>Ensure reports generated by Striae are accurate, clearly labeled, and only distributed to individuals authorized to access them.</li>
            <li>You are solely responsible for the accuracy, sufficiency, and legal adequacy of any reports or conclusions derived from Your use of the Service.</li>
          </ul>
          <h3>Accountability and Continuous Improvement</h3>
          <ul>
            <li>Regularly review and update your use of Striae’s features as new improvements are released.</li>
            <li>Share constructive feedback and participate in community feature discussions to help improve Striae’s effectiveness for all users.</li>
          </ul>
          <h3>Fair and Lawful Use</h3>
          <ul>
            <li>Do not use Striae for unauthorized surveillance, personal interest, or any unlawful activity.</li>
            <li>Never attempt to reverse-engineer or bypass security features protecting the application or user data.</li>
          </ul>
        </section>
        <section className={styles.section}>
...
<p>You are solely responsible for ensuring that Your use of the Service, including any storage or processing of case-related materials, complies with all applicable laws, rules of evidence, court orders, protective orders, and accreditation or institutional requirements.</p>
<h3>Data Integrity</h3>
<p>Except for automated processing that is technically necessary for storage, transmission, resizing, compression, or display, the Company will not edit the substantive contents of Your Data. The role of Striae is to store, display, and make Your Data accessible to You, and You remain in control of its substantive content.</p>
<h3>Data Backups</h3>
<p>The Company does not perform local or customer-specific backup services for Your Data. Data and images are stored through cloud infrastructure providers (including Cloudflare R2, KV, and Images), and the Company does not guarantee that any backup, replication, or recovery copy will be available, correct, or complete.</p>
...
<p>Before initiating arbitration, You agree to first contact Striae at the contact address provided on the Striae website and attempt to resolve the dispute informally in good faith. Striae will likewise attempt to resolve disputes informally. If a dispute is not resolved within 30 days of the initial notice, either party may proceed to arbitration as described below.</p>
    <p>You must send Your notice in writing to the contact email or postal address listed in the Contact Us section and include a brief description of the dispute and the relief sought.</p>
...
<ul>
  ...
  <p>Access requests and Data transfers are logged in detail, allowing Us to audit activities and identify any unauthorized access attempts. Audit trail records are retained indefinitely for security, forensic integrity, and compliance purposes.</p></li>
...
<li>
  ...
  <p>Striae will never edit or modify the contents of Your Data without Your explicit input. The only edits made to Your Data will be for the purpose of resizing and compression for optimal display, storage, and performance. When You delete Data, it is removed from active systems and will not be accessible through the Service. Residual copies may remain for a limited period in system logs, temporary caches, or provider-level replicated storage until they are overwritten or deleted in the ordinary course of business.</p>
</li>
<li>
<p><strong>Account Deletion</strong></p>
<p>If You choose to delete Your account, associated Data and information will be removed from active systems and will no longer be accessible through the Service. Certain residual records may persist for a limited period in logs, temporary caches, or provider-level replicated storage, and may be retained where required for security, legal, or compliance purposes. Audit trail records are retained indefinitely and are not deleted as part of account deletion. Subject to those limitations, deleted Data is not recoverable by You through the Service.</p>
</li>
</ul>
