...
export const buildUserLoginAuditParams = (input: BuildUserLoginAuditParamsInput): CreateAuditEntryParams => {
	return {
...
export const buildUserLogoutAuditParams = (input: BuildUserLogoutAuditParamsInput): CreateAuditEntryParams => {
	return {
		userId: input.user.uid,
		userEmail: input.user.email || '',
		action: 'user-logout',
...
export const buildUserProfileUpdateAuditParams = (input: BuildUserProfileUpdateAuditParamsInput): CreateAuditEntryParams => {
	return {
		userId: input.user.uid,
		userEmail: input.user.email || '',
...
export const buildPasswordResetAuditParams = (input: BuildPasswordResetAuditParamsInput): CreateAuditEntryParams => {
	return {
		userId: '',
...
export const buildAccountDeletionAuditParams = (input: BuildAccountDeletionAuditParamsInput): CreateAuditEntryParams => {
	return {
		userId: input.userId,
		userEmail: input.userEmail || '',
...
export const buildUserRegistrationAuditParams = (input: BuildUserRegistrationAuditParamsInput): CreateAuditEntryParams => {
	return {
		userId: input.user.uid,
		userEmail: input.user.email || '',
...
export const buildMfaEnrollmentAuditParams = (input: BuildMfaEnrollmentAuditParamsInput): CreateAuditEntryParams => {
	return {
		userId: input.user.uid,
		userEmail: input.user.email || '',
		...
		securityDetails: {
			...
			...(input.mfaMethod === 'sms' && input.phoneNumber ? { phoneNumber: getMaskedPhoneNumber(input.phoneNumber) } : {}),
...
export const buildMfaAuthenticationAuditParams = (input: BuildMfaAuthenticationAuditParamsInput): CreateAuditEntryParams => {
	return {
		userId: input.user.uid,
		userEmail: input.user.email || '',
...
export const buildEmailVerificationAuditParams = (input: BuildEmailVerificationAuditParamsInput): CreateAuditEntryParams => {
	return {
		userId: input.user.uid,
		userEmail: input.user.email || '',
...
export const buildEmailVerificationByEmailAuditParams = (input: BuildEmailVerificationByEmailAuditParamsInput): CreateAuditEntryParams => {
...
export const buildSecurityViolationAuditParams = (input: BuildSecurityViolationAuditParamsInput): CreateAuditEntryParams => {
	...
	return {
		...
		securityDetails: {
			...
			mitigationSteps: [blockedBySystem ? 'Automatically blocked by system' : 'Manual intervention required'],
		},
	};
};
