...
export const buildAnnotationCreateAuditParams = (input: BuildAnnotationCreateAuditParamsInput): CreateAuditEntryParams => {
...
export const buildAnnotationEditAuditParams = (input: BuildAnnotationEditAuditParamsInput): CreateAuditEntryParams => {
...
export const buildAnnotationDeleteAuditParams = (input: BuildAnnotationDeleteAuditParamsInput): CreateAuditEntryParams => {
	const annotationSnapshot = toAnnotationSnapshot(input.annotationData);
