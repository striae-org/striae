...
export const buildCaseCreationAuditParams = (input: BuildCaseCreationAuditParamsInput): CreateAuditEntryParams => {
	return {
...
export const buildCaseRenameAuditParams = (input: BuildCaseRenameAuditParamsInput): CreateAuditEntryParams => {
	return {
		userId: input.user.uid,
		userEmail: input.user.email || '',
		action: 'case-rename',
...
export const buildCaseDeletionAuditParams = (input: BuildCaseDeletionAuditParamsInput): CreateAuditEntryParams => {
	return {
		userId: input.user.uid,
		userEmail: input.user.email || '',
		action: 'case-delete',
...
export const buildCaseArchiveAuditParams = (input: BuildCaseArchiveAuditParamsInput): CreateAuditEntryParams => {
...
export const buildFileUploadAuditParams = (input: BuildFileUploadAuditParamsInput): CreateAuditEntryParams => {
	const result = input.result || 'success';
...
export const buildFileDeletionAuditParams = (input: BuildFileDeletionAuditParamsInput): CreateAuditEntryParams => {
	return {
		userId: input.user.uid,
		userEmail: input.user.email || '',
		action: 'file-delete',
...
export const buildPDFGenerationAuditParams = (input: BuildPDFGenerationAuditParamsInput): CreateAuditEntryParams => {
	return {
		userId: input.user.uid,
		userEmail: input.user.email || '',
		action: 'pdf-generate',
