...
export const ExistingCaseSection = ({ existingReadOnlyCase, selectedFile, onClear, isClearing, isImporting }: ExistingCaseSectionProps) => {
	...
	return (
		<div className={styles.warningSection}>
			...
			<button className={styles.clearButton} onClick={onClear} disabled={isClearing || isImporting}>
