		...
		<div className={styles.toolbarContainer}>
			<div className={`${styles.toolbar} ${!isVisible ? styles.hidden : ''}`}>
				...
				<div className={styles.toolbarContent} role="toolbar" aria-label="Annotation tools">
					...
					/>
					<Button iconId="item" isActive={activeTools.has('item')} onClick={() => handleToolClick('item')} ariaLabel="Item Type" />
					<Button iconId="index" isActive={activeTools.has('index')} onClick={() => handleToolClick('index')} ariaLabel="Index Marks" />
					<Button iconId="id" isActive={activeTools.has('id')} onClick={() => handleToolClick('id')} ariaLabel="Support Level" />
					<Button
						iconId="box"
