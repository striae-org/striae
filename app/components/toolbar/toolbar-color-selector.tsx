...
export const ToolbarColorSelector = ({ selectedColor, onColorConfirm, onCancel, isVisible }: ToolbarColorSelectorProps) => {
		...
		<div className={styles.toolbarColorSelector}>
			...
			<div className={styles.colorSelectorContent}>
				<div className={styles.toggleSection}>
					<button onClick={() => setShowColorWheel(!showColorWheel)} className={styles.colorToggleButton}>
