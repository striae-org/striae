	...
	return (
		<div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
			...
			<div className={styles.footerSection}>
				<button onClick={() => setIsFooterModalOpen(true)} className={styles.footerSectionButton}>
					About & Support
				</button>
			</div>
				...
				<div className={styles.footerModalOverlay} {...overlayProps} aria-label="Close About and Support dialog">
					<div className={styles.footerModal} onClick={(e) => e.stopPropagation()}>
						<div className={styles.footerModalHeader}>
							...
							<button className={styles.footerModalClose} {...getCloseButtonProps({ ariaLabel: 'Close About and Support dialog' })}>
								×
							</button>
						</div>
						<div className={styles.footerModalContent}>
							<div className={styles.footerModalLinks}>
								<Link to="https://striae.org/support" target="_blank" rel="noopener noreferrer" className={styles.footerModalLink}>
									Need Help?
								</Link>
								<Link to="https://striae.org/bugs" target="_blank" rel="noopener noreferrer" className={styles.footerModalLink}>
									Report a Bug
								</Link>
								<Link to="https://striae.org/privacy" target="_blank" rel="noopener noreferrer" className={styles.footerModalLink}>
									Privacy Policy
								</Link>
								<Link to="https://striae.org/terms" target="_blank" rel="noopener noreferrer" className={styles.footerModalLink}>
									Terms of Service
								</Link>
								<Link to="https://striae.org/security" target="_blank" rel="noopener noreferrer" className={styles.footerModalLink}>
									Security Policy
								</Link>
								<Link
