		...
		<div className={styles.overlay} aria-label="Close image notes dialog" {...overlayProps}>
			...
			{isCloseAlertOpen && (
				<div className={styles.modalOverlay}>
					...
					>
						<h3 id={closeAlertTitleId} className={styles.modalTitle}>
						...
						<div className={styles.unsavedChangesActions}>
							...
							<button type="button" onClick={handleCancelClose} className={styles.secondaryButton} disabled={isSavingBeforeClose}>
								Continue Editing
							</button>
						</div>
					</div>
