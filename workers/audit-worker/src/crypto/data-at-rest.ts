...
import type { DataAtRestEnvelope, DecryptionTelemetryOutcome, Env, PrivateKeyRegistry } from '../types';
...
async function decryptJsonFromStorage(ciphertext: ArrayBuffer, envelope: DataAtRestEnvelope, privateKeyPem: string): Promise<string> {
