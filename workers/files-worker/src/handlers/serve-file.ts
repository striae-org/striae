...
export async function handleFileServing(request: Request, env: Env, fileId: string, respond: CreateResponse): Promise<Response> {
	...
	const contentDisposition = buildSafeContentDisposition(filename, fileId, 'attachment');
