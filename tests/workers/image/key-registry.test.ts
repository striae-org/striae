...
/**
 * Tests for workers/image-worker/src/security/key-registry.ts
 *
 * Validates the R2-backed key registry fetch + candidate fallback chain used
 * when decrypting stored images.
 */

import { describe, it, expect, beforeAll } from 'vitest';
import { decryptBinaryWithRegistry } from '../../../workers/image-worker/src/security/key-registry';
import { encryptBinaryForStorage } from '../../../workers/image-worker/src/encryption-utils';
import { encryptRegistryJson } from '../../../shared/registry/registry-encryption';
import type { Env } from '../../../workers/image-worker/src/types';
