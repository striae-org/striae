...
/**
 * Tests for workers/files-worker/src/encryption-utils.ts
 *
...
import { encryptBinaryForStorage, decryptBinaryFromStorage, validateEnvelope } from '../../../workers/files-worker/src/encryption-utils';
